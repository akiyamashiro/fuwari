...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/demo-banne2r.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	...
	links: [
		{
			...
			url: "https://space.bilibili.com/8382567",
		},
		{
			name: "GitHub",
